...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				setGraphicSize(Std.int(width * 0.937));
				

				addOffset('idle');
				addOffset("singUP", -30, 87);
				addOffset("singRIGHT", -97, 2);
				addOffset("singLEFT",  43, 15);
				addOffset("singDOWN", -140, -69);
			...
			case 'bf':
				...
				addOffset("singDOWN", -24, -63);

				addOffset("singUPmiss", -48, 41);
				addOffset("singRIGHTmiss", -18, 41);
				addOffset("singLEFTmiss", -1, -1);
				addOffset("singDOWNmiss", -17, -31);

				addOffset('idle-stressed', -5);
				addOffset("singUP-stressed", -27, 58);
				addOffset("singRIGHT-stressed", -43, 5);
				addOffset("singLEFT-stressed", 20, 7);
				addOffset("singDOWN-stressed", -10, -45);

				addOffset("singUPmiss-stressed", -29, 67);
				addOffset("singRIGHTmiss-stressed", -18, 41);
				addOffset("singLEFTmiss-stressed", 4, 34);
				addOffset("singDOWNmiss-stressed", -37, -56);

				addOffset("hey", -6, 10);
				addOffset('firstDeath', -10, 9);
				addOffset('deathLoop', -9, 8);
				addOffset('deathConfirm', -34, 80);
	...
	public function dance()
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gfpico':
