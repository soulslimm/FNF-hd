...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{	
			default:
				if(sys.FileSystem.exists("assets/data/" + SONG.song.toLowerCase() + "/" + SONG.song.toLowerCase() + "-dialogue.txt")){
		...
		default:
		{
			...
			freshCrowd.setGraphicSize(Std.int(freshCrowd.width * 1.6));
	...
	override public function update(elapsed:Float)
	{
		...
		if (healthBar.percent < 40)
			Boyfriend.fuckCval = true;
			else
			Boyfriend.fuckCval = false;
	...
	function noteMiss(direction:Int = 1):Void
	{
		...
		switch (direction) {
			...
			case 0:
					boyfriend.playAnim('singLEFTmiss' + isStressed, true);
				case 1:
					boyfriend.playAnim('singDOWNmiss' + isStressed, true);
				case 2:
					boyfriend.playAnim('singUPmiss' + isStressed, true);
				case 3:
					boyfriend.playAnim('singRIGHTmiss' + isStressed, true);
			}
	}
}
